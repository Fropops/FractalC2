...
namespace WebCommander.Commands.Custom
{
    public class CustomCommandAgentAdaptater<T> : ICommandAgent
    {
        ...
        public ParameterDictionary ContextParameters { get; private set; } = new ParameterDictionary();

        public AgentMetadata Metadata => metadata;

        public CustomCommandAgentAdaptater(AgentMetadata metadata)
        {
            this.metadata = metadata;
            this.tasks = new List<AgentTask>();
        }
        ...
        public void AddParameter<U>(ParameterId id, U item)
        {
            ContextParameters.AddParameter(id, item);
        }
