    ...
    public class GetSystemCommand : AgentCompositeCommand<GetSystemCommandOptions>
    {
        ...
        protected override async Task<bool> Run(AgentCommandContext context, GetSystemCommandOptions options)
        {
            ...
            if (string.IsNullOrEmpty(options.endpoint))
            {
                ...
                context.WriteLine($"No Endpoint selected, taking the current agent enpoint ({options.endpoint})");
            }
            ...
            context.WriteLine($"[>] Preparing to upload the file...");
            ...
            context.Delay(1);
            context.WriteInfo($"[>] Preparing Service...");
