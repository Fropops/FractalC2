...
DotNet Command and Control for Pentesting Operations

## Installation
One liner, Full install
```
wget -qO- https://raw.githubusercontent.com/Fropops/FractalC2/refs/heads/master/Install/install.sh | bash -s -- All
```
...
```
wget -qO- https://raw.githubusercontent.com/Fropops/FractalC2/refs/heads/master/Install/install.sh | bash -s -- TeamServer
```
